# P0 检查规则清单 - 3.7.0-SNAPSHOT

> 基于 3.6.0-SNAPSHOT 基线版本。**TODO**: 请在此补充 3.7.0 版本的规则差异。

## P0-01：Controller→Controller 直接依赖
...
## P0-02：Controller 直接依赖 DAO/Mapper
...
## P0-03：Controller 注入 ServiceImpl 而非 Service 接口
