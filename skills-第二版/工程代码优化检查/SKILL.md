...
本技能针对 `element-module/grp-capability-element/element-server-com` 下 `@Service` 和 `@Repository` 类进行系统化代码质量优化，包含三大核心功能：
...
| 场景 | 触发关键词 |
|------|-----------|
| 修复 SQL 注入安全漏洞 | "SQL注入修复"、"安全修复"、"参数化查询" |
| 增强日志记录 | "日志增强"、"添加日志"、"@Slf4j" |
| 清理冗余代码 | "代码清理"、"代码优化"、"冗余清理" |
| 全量优化（三合一） | "工程代码优化"、"模块优化"、"代码质量优化" |
