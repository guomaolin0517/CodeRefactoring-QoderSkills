# 四层架构工程检查与重构 - 3.7.0-SNAPSHOT 版本规则
...
本文件为 **3.7.0-SNAPSHOT** 版本的四层架构工程检查与重构规则。
...
重构流程与 3.6.0-SNAPSHOT 基线版本结构一致，具体差异见各 scripts/ 文件。

> **TODO**: 如果 3.7.0 版本在某些 Phase 有差异，请在此处覆盖说明。
