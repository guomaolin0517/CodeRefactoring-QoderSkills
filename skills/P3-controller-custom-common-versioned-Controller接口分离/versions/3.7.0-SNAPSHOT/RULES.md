# P3 Controller 接口分离检查与修复 - 3.7.0-SNAPSHOT 版本规则
...
本文件为 **3.7.0-SNAPSHOT** 版本的 P3 Controller 接口分离检查与修复规则。
...
| 文件 | 说明 |
|------|------|
| [scripts/check-rules.md](scripts/check-rules.md) | P3 检查规则清单 |
| [scripts/refactor-rules.md](scripts/refactor-rules.md) | P3 修复规范 |
