# P0 架构依赖检查与修复 - 3.7.0-SNAPSHOT 版本规则
...
本文件为 **3.7.0-SNAPSHOT** 版本的 P0 架构依赖检查与修复规则。
...
| 文件 | 说明 |
|------|------|
| [scripts/check-rules.md](scripts/check-rules.md) | P0 检查规则清单 |
| [scripts/refactor-rules.md](scripts/refactor-rules.md) | P0 修复规范 |
